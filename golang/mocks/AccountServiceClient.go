...
// CheckResetToken provides a mock function with given fields: ctx, in, opts
func (_m *AccountServiceClient) CheckResetToken(ctx context.Context, in *golang.CheckResetTokenRequest, opts ...grpc.CallOption) (*golang.CheckResetTokenResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if rf, ok := ret.Get(0).(func(context.Context, *golang.CheckResetTokenRequest, ...grpc.CallOption) *golang.CheckResetTokenResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *golang.CheckResetTokenRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
